...
<body>
    ...
    <div class="mb-5" style="position: relative;">
        ...
        <div class="" style=" position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
            ...
            <a href="services.php" class="fw-bold text-decoration-none text-dark text-center text-white mx-3">Services</a>
            <h1 class="fw-bold text-center text-white">Services</h1>
        </div>
    </div>
    <!-- services -->
    <?php
